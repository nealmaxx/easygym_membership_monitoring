        ...
        <div class="container-fluid bd-gutter mt-3 my-md-4 bd-layout flex-grow-1">
            ...
            <div class="custom-offcanvas" id="customSidebar">
                ...
                <div class="offcanvas-body">
                    ...
                    <button class="btn btn-sidebar btn-outline-primary text-start"
                        data-url=""><i class="fas fa-tachometer-alt"></i>
                        Dashboard</button>
                    <button class="btn btn-sidebar btn-outline-primary text-start"
                        data-url="../admin/members.php"><i class="fas fa-users"></i>
                        Members</button>
                    <button class="btn btn-sidebar btn-outline-primary text-start"
                        data-url="../admin/instructors.php"><i class="fas fa-user-friends"></i>
                        Instructors</button>
                    <button class="btn btn-sidebar btn-outline-primary text-start"
                        data-url="../admin/membership_details.php"><i class="fas fa-id-card-alt"></i>
                        Membership
                        Management</button>
                    <button class="btn btn-sidebar btn-outline-primary text-start"
                        data-url="../admin/member_overview_status.php"><i class="fas fa-credit-card"></i> Payment
                        and Account Activation</button>
                    <button class="btn btn-sidebar btn-outline-primary text-start"
                        data-url=""><i class="fas fa-chart-line"></i> Generate
                        Income Reports</button>
