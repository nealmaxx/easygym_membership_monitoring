        ...
        <div class="container-fluid bd-gutter mt-3 my-md-4 bd-layout flex-grow-1">
            ...
            <div class="custom-offcanvas" id="customSidebar">
                ...
                <button class="btn btn-sidebar btn-outline-primary text-start" id="profileButton"
                    data-url="../client/personal_info.php">
                    <i class="fas fa-user-friends"></i> Personal Information
                </button>
                <button class="btn btn-sidebar btn-outline-primary text-start"
                    data-url="../client/workout_program.php">
                    <i class="fas fa-id-card-alt"></i> Workout Program
                </button>
                <button class="btn btn-sidebar btn-outline-primary text-start"
                    data-url="../client/progress_tracking.php">
                    <i class="fas fa-credit-card"></i> Progress Tracking
                </button>
                <button class="btn btn-sidebar btn-outline-primary text-start"
                    data-url="../client/setting.php">
